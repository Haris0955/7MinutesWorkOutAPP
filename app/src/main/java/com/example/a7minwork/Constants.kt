...
object Constants {
    ...
    fun getDefaultExerciseList(): ArrayList<ExerciseModel> {
        ...
        myExerciseList.add(highKneesRunningInPlace)

        val lunges = ExerciseModel(10, "Lunges", R.drawable.ic_lunge, false, false)
        myExerciseList.add(lunges)
